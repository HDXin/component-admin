...
export default {
	...
	methods: {
		updateCity: function () { // 当省份的model发生变化的时候调用
		...
		updateDistrict: function () { // 当城市的model发生变化的时候调用
			...
			if(this.districtArr && this.districtArr.length > 0 && this.districtArr[1].name) { //判断区域选择的时候默认选择第一个
