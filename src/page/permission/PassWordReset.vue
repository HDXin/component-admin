<template>
    <span class="impSkuDialog">
        <el-dialog title="重置密码" :visible.sync="show" size="tiny" :close-on-click-modal="false" @open="handleOpen" @close='close'>
            <el-form :model="form" label-position="top"  ref="ruleForm" :rules="rules">
                <el-form-item style="margin-bottom: 20px" required label="旧密码" label-width="120px" prop="password">
                    <el-input type="password" v-model="form.password"></el-input>
                </el-form-item>
                <el-form-item style="margin-bottom: 20px" required label="新密码"  label-width="120px" prop="newPassword">
                    <el-input type="password" v-model="form.newPassword" ></el-input>
                </el-form-item>
                <el-form-item style="margin-bottom: 20px" required label="再次输入" label-width="120px" prop="newPassword2">
...
<script>
    ...
    import {portalApi } from '@/page/permission/api'
            ...
            gotoReset(formName){
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                       ...
                       portalApi.updatePasswordApi(_form).then(function (res) {
                            vm.$message({
                                type:'success',
                                message:'修改成功'
                            })
